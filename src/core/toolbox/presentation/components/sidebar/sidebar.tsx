  ...
  return (
    <nav className="flex h-full w-[248px] shrink-0 flex-col overflow-hidden border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
      <div className="flex items-center gap-2.5 px-[18px] pb-4 pt-5">
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-indigo-500 text-base font-extrabold text-white">
          T
        </div>
      ...
      <div className="px-3.5 pb-3.5">
        <input
          ...
          className="w-full rounded-lg border border-slate-200 bg-slate-50 px-2.5 py-2 font-sans text-[13px] text-slate-900 outline-none focus:border-indigo-400 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
        />
      </div>
