...
import {
  ConvertUrlUseCase,
  type UrlMode,
} from '@/core/toolbox/application/use-cases/convert-url/convert-url.use-case';
...
export function UrlPanel({
  ...
  const [input, setInput] = useState('hello world?a=1&b=2');
  ...
  return (
    <ToolPanelFrame>
      ...
      <TextareaField
        label={mode === 'encode' ? t.labels.plainText : t.labels.urlEncodedText}
        rows={4}
        value={input}
