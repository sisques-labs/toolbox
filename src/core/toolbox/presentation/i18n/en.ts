const dict = {
  ...
  tools: {
    ...
    'device-info': {
      ...
      description: 'Inspect your browser and device environment',
    },
    'random-port': {
    ...
    'git-cheatsheet': {
      ...
      description: 'Search common git commands and what they do',
    },
    'regex-cheatsheet': {
    ...
    'phone-parser': {
      label: 'Phone parser',
      description: 'Parse an international phone number into its parts',
    },
  },
  actions: {
    copy: 'Copy',
  ...
  labels: {
    ...
    yes: 'Yes',
    no: 'No',
    portWellKnown: 'Well-known (0-1023)',
  ...
  errors: {
    ...
    invalidPhone: 'Enter a number starting with + and a recognized dial code',
